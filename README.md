...
Pythonは、PHPと比べて「WEBアプリの機能実装」において、便利さが劣っている気がします。

WEBアプリを作ることに時間をかけてきたPHPは、なんだかんだすごいのかも。

Pythonは、「WEBアプリの機能実装」を支える機能がすごい優秀です。

本屋さんにいくと、Pythonの方が書籍が多い印象です。

WEB開発だけでなく、ゲーム開発だったり、データ分析だったり、非エンジニア用の自動化ツール等、いっぱいあります。

ゲーム開発、データ分析、非エンジニア用の自動化ツール等がWEB開発をさらに発展させてくれる気がします。

そして、最終的に私が目指す「高速開発」の域に近づけるのではないかと思っています。
